...
AnomissPopup.Name = "AnomissPopup"
...
TextLabel_3.Text = "Anomiss Lite (Anomic V)"
...
TextButton.MouseButton1Click:Connect(function()
    Close()
    loadstring(game:HttpGet("https://anomiss.in/Scripts/Anomic.lua"))()    
end)
