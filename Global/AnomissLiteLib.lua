...
local themes = {
	...
	Glow = Color3.fromRGB(173, 160, 11), 
	Accent = Color3.fromRGB(10, 10, 10), 
	LightContrast = Color3.fromRGB(20, 20, 20), 
	DarkContrast = Color3.fromRGB(14, 14, 14),  
	TextColor = Color3.fromRGB(212, 212, 212),
    TextColor2 = Color3.fromRGB(233, 210, 10)
}
...
if game.PlaceId == 4581966615 then
    ...
    local function ApplyDev(v)
        local s,e = pcall(function()
            ...
            if string.find(v.Name, "Bon") then
...
do
	...
	function library:SelectPage(page, toggle)
		...
		if toggle then
			-- page button
            button.Title.TextColor3 = themes.TextColor2
			button.Title.TextTransparency = 0
			button.Title.Font = Enum.Font.GothamSemibold
			
			if button:FindFirstChild("Icon") then
				button.Icon.ImageTransparency = 0
                button.Icon.ImageColor3 = themes.TextColor2
			end
